...
# 取前多少个常用字  
# Todo: store the words array into tf constant!!
...
def neural_network(model='lstm', rnn_size=128, num_layers=2):  
    ...
    with tf.variable_scope('rnnlm'):  #I don't know why they decided to increase output size 1
...
def train_neural_network():  
    ...
    with tf.Session() as sess:  
        ...
        for epoch in range(50):  
            ...
            if epoch % 7 == 0:  
                saver.save(sess, '/tmp/poetry/poetry', global_step=epoch)  
